...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		DBCommon<Student> dbCommon = new DBCommon<Student>("c:\\tomcat(apache)\\student190527.sqlite", "student");
//		ArrayList<Student> studentList = dbCommon.selectArrayList(new Student());
