...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		DBCommon<Player> dbCommon = new DBCommon<Player>("c:\\tomcat(apache)\\player.sqlite", "player");
	...
	public String battle(Locale locale, Model model, @RequestParam(value="chk_info", required=false) List<Integer> values){
		...
		DBCommon<Player> dbCommon2 = new DBCommon<Player>("c:\\tomcat(apache)\\player.sqlite", "PvP");
	...
	public String PvP(Locale locale, Model model, @RequestParam(value="user", required=true) List<Integer> values) {
		DBCommon<Player> dbCommon = new DBCommon<Player>("c:\\tomcat(apache)\\player.sqlite", "PvP");
